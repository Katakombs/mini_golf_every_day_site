...
Safely identifies and stops orphaned processes related to the mini golf site
"""
...
def main():
    ...
    print("🧹 Mini Golf Every Day - Process Cleanup")
    print("=" * 50)
    ...
    response = input("Do you want to stop these processes? (y/N): ").lower().strip()
    ...
    print(f"\n✅ Cleanup complete! Stopped {stopped_count}/{len(orphaned)} processes")
